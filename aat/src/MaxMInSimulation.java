...
public class MaxMInSimulation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create Datacenters
            // Datacenters are the resource providers in CloudSim. We need atleast one of
    ...
    private static Datacenter createDatacenter(String name) {
        ...
        hostList.add(
                new Host(
                        ...
                        storage,
                        peList1,
                        new VmSchedulerTimeShared(peList1))); // first machine
        ...
        // Create a DatacenterCharacteristics object that stores the properties of a
        // data center
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        Log.printLine("Cloudlet ID" + indent + indent + "STATUS" + indent + indent +
                ...
                + indent + indent + "Start Time" + indent + indent + indent + indent + "Finish Time" + indent + indent
                + "Response time");
        String indent2 = "      ";
